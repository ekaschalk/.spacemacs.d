...
Read on if you value:

1. A practical, modern, and customizable aesthetic.
2. You use Evil and are open to overwriting Emacs navigation commands.
3. Documented, modular, and idiomatic emacs lisp.
